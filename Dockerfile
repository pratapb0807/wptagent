...
CMD python /wptagent/wptagent.py --server "http://wpt1.speedcurve.com/work/" --location "salesforce-01" --key "6spP6RTwq9UmAPYCQd8aPx8ULhjtGx"  --shaper none --shm-size=1gb --xvfb --dockerized -vvvvv --log wptagent.log
